...
object HighResLutProcessor {
    ...
    suspend fun applyLut(
        ...
        // Determine number of parallel chunks based on image size
        val numChunks = if (totalPixels > 1_000_000) 8 else if (totalPixels > 100_000) 4 else 1
        val chunkSize = (totalPixels + numChunks - 1) / numChunks
